...
// générer un nombre aléatoire en appelant la fonction qu'on a codé au dessus
var nombreATrouver = nbRandom();
// demander à l'utilsiateur un nombre
var saisie = prompt("Saisissez un nombre entier entre 1 et 20 :");

// comparer le nombre à trouver et le nombre saisi
while(saisie != nombreATrouver) {
	// on rentre dans le while si il a pas trouvé
	// puis on lui dit si il a tapé au dessus ou en dessous
	...
	// on lui redemande un nouveau nombre, et on reste la condition du while
	saisie = prompt("Saisissez un nombre entier entre 1 et 20 :");
}

// quand on sors du while, c'est forcément que saisie == nombreATrouver
// donc c'est gagné
alert("Bravo !");
